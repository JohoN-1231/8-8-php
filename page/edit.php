<main class="main">
            <section class="head">
                ...
                <form action="./includes/user-avatar.php" method="POST" enctype="multipart/form-data" class="userForm">
                    ...
                    <input type="file" name="avatar[]" accept="image/jpg,image/jpeg,image/png,image/svg,/image/gfif" multiple>
                    <button class="form__btn">Дабавит</button>
                </form>
                <br>
                <form action="./includes/user-edit-photos.php" method="POST" class="avatars">
                    <?foreach ($getPhotos as $key => $value): ?>
                        <label class="avatars__label">
                            ...
                            <span class="avatars__span"><i class="far fa-check"></i></span>
                ...
                <br>
                <form action="./includes/user-edit-info.php" method="POST" class="user-infouser-info">
                    <fieldset class="user-info__fieldset">
                        <legend>Изменить инфо</legend>
                        <input class="form__input" type="text" name="login" value="<?=$userInfo['user_login']?>">
                        <legend>Изменить имя</legend>
                        <input class="form__input" type="text" name="name" value="<?=$userInfo['user_name']?>">
